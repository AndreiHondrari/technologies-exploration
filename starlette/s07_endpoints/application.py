...
class ThisEndpoint(HTTPEndpoint):
...
class ThatEndpoint(HTTPEndpoint):
...
ROUTES = [
    Route('/', IndexEndpoint, name="home"),
    Mount('/some/', routes=[
        Route('/this', ThisEndpoint, name="this_page"),
        Route('/that', ThatEndpoint, name="that_page"),
    ]),
]
